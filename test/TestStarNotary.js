...
it('can add the star name and star symbol properly', async() => {
    ...
    let tokenId = 6;
    let instance = await StarNotary.deployed();
    await instance.createStar('Awesome Star 2!', tokenId, {from: owner});
...
it('lets 2 users exchange stars', async() => {
    ...
    let user1 = accounts[1];
    let user2 = accounts[2];
    await instance.createStar('User 1 Star!', tokenId1, {from: user1});
    await instance.createStar('User 2 Star!', tokenId2, {from: user2});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let instance = await StarNotary.deployed();
    let user1 = accounts[1];
    await instance.createStar('Star Name', tokenId, {from: user1});
    assert.equal(await instance.lookUptokenIdToStarInfo(tokenId), 'Star Name');
});