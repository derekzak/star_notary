...
contract StarNotary is ERC721, ERC721Metadata {
    ...
    constructor() public ERC721Metadata("StarNotary", "STR") {}
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        require(bytes(foundStar.name).length != 0, "Star not found");
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((ownerAddress1 == msg.sender) || (ownerAddress2 == msg.sender), "Only the owner of a Star can exchange the Star");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "Only the owner of a Star can transfer the Star");
